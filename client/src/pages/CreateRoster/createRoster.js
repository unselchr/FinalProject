  ...
  <div>
    <div>
      ...
      <div class="btn-group" role="group" aria-label="Basic example">
        <button type="button" class="btn btn-secondary">CHAOS</button>
        <button type="button" class="btn btn-secondary">IMPERIUM</button>
        <button type="button" class="btn btn-secondary">XENOS</button>
        <button type="button" class="btn btn-secondary">FORGE WORLD</button>
      </div>
    </div>
