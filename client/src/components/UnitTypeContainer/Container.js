  ...
  updateNums() {
    if (this.state.units) {
      if (this.state.units.length) {
        ...
        this.state.returnNums({category:this.state.type,points:pt,powerLevel:pl});
      }
      else {
        this.setState({ totalPoints: this.state.units.points, totalPL: this.state.units.powerLevel });
        this.state.returnNums({ category: this.state.type, points: this.state.units.points, powerLevel: this.state.units.powerLevel });
      }
    }
...
export default UnitTypeContainer;